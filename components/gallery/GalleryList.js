...
import GalleryContext, { GalleryContextProvider } from "../../Store/Gallery-context";
                ...
                <Col sm={6} md={4} lg={3}>
                  <Card style={{ maxWidth: "345px", margin: "15px" }}>
                    <Card.Body>
                      ...
                      <Card.Subtitle className="mb-2 text-muted">{gallery.createdAt}</Card.Subtitle>
                      <div style={{ minHeight: "300px", maxHeight: "300px" }} onClick={() => handleItemClick(gallery)}>
                        <Card.Img
                          variant="top"
                          src={imgSrc}
                          syle={{
